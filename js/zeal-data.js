...
(function () {
  ...
  const API_BASE = _isLocal ? 'http://localhost:5000/api' : 'https://zeal-backend-final.onrender.com/api';
  const IMG_BASE = _isLocal ? 'http://localhost:5000' : 'https://zeal-backend-final.onrender.com';
